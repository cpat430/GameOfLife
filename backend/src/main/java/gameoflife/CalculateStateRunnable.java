...
public class CalculateStateRunnable implements Runnable {
    ...
    public CalculateStateRunnable(int[][] gameBoard, int startingI, int startingJ, int endI, int endJ, boolean isMutant) {
    ...
    @Override
    public void run() {
        this.nextBoardSegment = gameOfLife.calculateNextStateMultithreaded(gameBoard, startingI, startingJ, endI, endJ, isMutant);
    }
