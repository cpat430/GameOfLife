...
public class MultithreadingCalculationProcess {
        ...
        public static int[][] getNextMultithreadedState(int[][] currentBoard, boolean isMutant)
                ...
                CalculateStateRunnable topLeftRunnable = new CalculateStateRunnable(currentBoard, 0, 0, middleI,
                                middleJ,
                                isMutant);
                CalculateStateRunnable topRightRunnable = new CalculateStateRunnable(currentBoard, 0, middleJ, middleI,
                                m,
                                isMutant);
                CalculateStateRunnable bottomLeftRunnable = new CalculateStateRunnable(currentBoard, middleI, 0, n,
                                middleJ,
                                isMutant);
                CalculateStateRunnable bottomRightRunnable = new CalculateStateRunnable(currentBoard, middleI, middleJ,
                                n, m,
                                isMutant);
                ...
                return BoardManipulation.mergeFourBoardSegments(n, m, topLeftBoardSegment, topRightBoardSegment,
                                bottomLeftBoardSegment, bottomRightBoardSegment);
        }
}
